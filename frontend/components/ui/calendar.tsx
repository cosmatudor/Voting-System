...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-slate-800 text-white", className)}
      classNames={{
        ...
        day_outside:
          "day-outside text-slate-400 aria-selected:bg-accent/50 aria-selected:text-muted-foreground",
        day_disabled: "text-slate-600 opacity-70",
        day_range_middle:
